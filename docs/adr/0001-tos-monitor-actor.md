...
Westinghouse Air Brake Technologies Corporation (Wabtec), per
ADR-2607110300 -- a read-only reference archive. As part of a 10-repo
validation batch extending the `cloud-itonami-lei-2572ibtt8cczw6au4141`
pilot (see ADR-2607241900/ADR-2607242000 for the full fleet-level design
...
- **Company**: Westinghouse Air Brake Technologies Corporation, LEI
  06BTX5UWZD0GQ5N5Y745, website `https://www.wabteccorp.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.wabteccorp.com/terms-of-use`,
