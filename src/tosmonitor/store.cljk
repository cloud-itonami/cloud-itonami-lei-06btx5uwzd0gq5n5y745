(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Westinghouse Air Brake
  Technologies Corporation, LEI 06BTX5UWZD0GQ5N5Y745) -- unlike
...
(defn demo-company []
  {:legal-name "Westinghouse Air Brake Technologies Corporation"
   :website    "https://www.wabteccorp.com"})

(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. The content of this site is provided by Westinghouse Air Brake Technologies Corporation (Wabtec) for informational purposes only and is subject to change without notice. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.wabteccorp.com/terms-of-use"
